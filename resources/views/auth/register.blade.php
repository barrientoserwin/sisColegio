@extends('layouts.formlogin', ['class' => 'register-page', 'page' => _('Pagina de Registro'), 'contentClass' => 'register-page'])
        ...
        <div class="col-md-5 ml-auto">
            <div class="info-area info-horizontal mt-5">
                ...
                <div class="description">
                    <h3 class="info-title">{{ _('Plantel Docente') }}</h3>
                    <p class="description">
            ...
            <div class="info-area info-horizontal">
                ...
                <div class="description">
                    <h3 class="info-title">{{ _('Acceso Apoderado') }}</h3>
                    <p class="description">
            ...
            <div class="info-area info-horizontal">
                ...
                <div class="description">
                    <h3 class="info-title">{{ _('Secretaria') }}</h3>
                    <p class="description">
            ...
            <div class="card card-register card-white">
                ...
                <form class="form" method="post" action="{{ route('register') }}">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary btn-round btn-lg">{{ _('Iniciar Sesion') }}</button>
                    </div>
                </form>
            </div>
        </div>
